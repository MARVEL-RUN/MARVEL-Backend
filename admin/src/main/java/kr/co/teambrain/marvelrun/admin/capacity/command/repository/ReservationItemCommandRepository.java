package kr.co.teambrain.marvelrun.admin.capacity.command.repository;
...
public interface ReservationItemCommandRepository
     ...
     */
    @Query("""
            select new kr.co.teambrain.marvelrun.admin.capacity.command.application.dto.ReservationAllocation(
