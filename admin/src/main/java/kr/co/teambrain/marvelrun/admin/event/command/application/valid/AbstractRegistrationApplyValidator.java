...
import kr.co.teambrain.marvelrun.admin.event.command.application.valid.dto.RegistrationPolicySelection;
import kr.co.teambrain.marvelrun.admin.event.command.application.valid.dto.RegistrationPolicyValidationResult;
...
public abstract class AbstractRegistrationApplyValidator {
    ...
    private final RefundRegistrationRepository
            registrationCommandRepository;

    private final RefundEventRepository
