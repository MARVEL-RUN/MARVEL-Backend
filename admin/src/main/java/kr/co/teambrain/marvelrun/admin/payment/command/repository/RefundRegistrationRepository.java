package kr.co.teambrain.marvelrun.admin.payment.command.repository;
...
@Repository
public interface RefundRegistrationRepository extends JpaRepository<Registration, String> {
    /**
